...
3. **Race-day pacing:** suggest a pacing strategy from their goal time and recent fitness (even effort or slight negative split for most distances; realistic target and a fallback). Note fueling/hydration for longer races.
