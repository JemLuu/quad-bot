...
`/init`, `/training-plan`, `/physical-therapist`, `/update`, `/log-run`, `/coach`, `/gear-tracker`, `/race-week`. Each lives in `.claude/skills/<name>/SKILL.md`. Shared knowledge is in `.claude/skills/_shared/`.
